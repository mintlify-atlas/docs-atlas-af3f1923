...
- [CSFDMovieCreator](/api/types/movie-types) - Creator reference in movie credits
- [CSFDSearchCreator](/api/types/search-types) - Creator in search results
- [CSFDCreators](/api/types/movie-types) - All creators organized by role